 ...
 */
void dlist_add_front(struct dlist *l, void *ptr, size_t memory);
 ...
 * @param ptr pointer to generic data to store in new list node
 */
void dlist_add_back(struct dlist *l, void *ptr, size_t memory);
...
/**
 * Iterate through dlist printing data and size
 */
