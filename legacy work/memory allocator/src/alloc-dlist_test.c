...
int main(int argc, char *argv[]) {
  ...
  dlist_add_back(mylist, str1, 1);
  dlist_add_back(mylist, str2, 2);
  dlist_add_back(mylist, str3, 3);
  dlist_add_back(mylist, str4, 4);
  dlist_add_back(mylist, str5, 5);
  ...
  dlist_add_front(mylist, str1, 30);
  dlist_add_front(mylist, str2, 40);
  dlist_add_front(mylist, str3, 50);
  dlist_add_front(mylist, str4, 60);
  dlist_add_front(mylist, str5, 70);
